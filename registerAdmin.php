<?php
    session_start();
    //Jika belum memasukkan KodeAdmin maka akan diarahkan ke login
	...
	if(isset($_POST['SUBMIT'])){
        try{
            ...
            if ($a == 7){
                ...
                $statement->bindValue(':IDLEVEL', "L001");
	...
	<div class="bg">
		<div class="card">
            ...
            <div class="user-box">
                ...
                <input type="password" name="PASSWORD" value="<?php if(isset($_POST['PASSWORD'])){echo $_POST['PASWORD'];} ?>">
